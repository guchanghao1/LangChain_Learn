...
# )
'''
ResponseFormat(punny_response='看来佛罗里达的天气真是"阳光灿烂"啊！这里的天气就像佛罗里达的橙子一样，总是那么"橙"意满满！不过要小心，这种天气可能会让你"晒"得有点"佛"不住哦！', 
weather_conditions="It's always sunny in Florida!")
'''
...
# )
'''
ResponseFormat(punny_response='不用客气！随时为你"预报"天气，这是我的"天职"！下次想知道天气，尽管"云"问我，我保证不会"雨"言又止！', 
weather_conditions=None)
'''
